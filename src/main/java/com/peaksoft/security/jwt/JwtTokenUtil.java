...
public class JwtTokenUtil {
    ...
    public Date getExpritionDate(String token){
        return getClaimsFromToken(token,Claims::getExpiration);
    }

    public <T> T getClaimsFromToken(String token, Function<Claims, T> claims){
    ...
    private Boolean isTokenExpired(String token){
        final Date expiration = getExpritionDate(token);
